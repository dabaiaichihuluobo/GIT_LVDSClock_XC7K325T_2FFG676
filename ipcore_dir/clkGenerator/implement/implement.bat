...
xst -ifn xst.scr
move clkGenerator_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clkGenerator_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clkGenerator_exdes.ucf clkGenerator_exdes

echo 'Running map'
map -timing -pr b clkGenerator_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clkGenerator_exdes -w routed.ncd routed.v
cd ..
